...
{
    public partial class MfPromv
 : Entity<int>    {
        public MfPromv()
        {
            TfPromv = new HashSet<TfPromv>();
        }

        
        public string PmvNo { get; set; }
        ...
        public virtual ICollection<TfPromv> TfPromv { get; set; }
    }
}