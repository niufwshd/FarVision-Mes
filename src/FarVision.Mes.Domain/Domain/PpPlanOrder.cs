...
{
    public partial class PpPlanOrder
 : Entity<int>    {
        public PpPlanOrder()
        {
            PpPlanOrders = new HashSet<PpPlanOrders>();
        }
        ...
        public string UsrNameExec { get; set; }
        ...
        public virtual ICollection<PpPlanOrders> PpPlanOrders { get; set; }
    }
}