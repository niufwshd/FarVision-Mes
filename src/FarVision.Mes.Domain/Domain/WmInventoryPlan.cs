...
{
    public partial class WmInventoryPlan
 : Entity<int>    {
        public WmInventoryPlan()
        {
            WmInventoryPlanItem = new HashSet<WmInventoryPlanItem>();
        }
        ...
        public virtual ICollection<WmInventoryPlanItem> WmInventoryPlanItem { get; set; }
    }
}