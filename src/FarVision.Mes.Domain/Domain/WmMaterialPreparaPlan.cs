...
{
    public partial class WmMaterialPreparaPlan
 : Entity<int>    {
        public WmMaterialPreparaPlan()
        {
            WmMaterialPreparaPlanItem = new HashSet<WmMaterialPreparaPlanItem>();
        }
        ...
        public virtual ICollection<WmMaterialPreparaPlanItem> WmMaterialPreparaPlanItem { get; set; }
    }
}