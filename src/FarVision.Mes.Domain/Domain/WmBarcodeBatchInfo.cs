...
{
    public partial class WmBarcodeBatchInfo
 : Entity<int>    {
        public WmBarcodeBatchInfo()
        {
            WmBarcodeBatchInfoHis = new HashSet<WmBarcodeBatchInfoHis>();
        }
        ...
        public virtual WmBarcode MidNavigation { get; set; }
        public virtual ICollection<WmBarcodeBatchInfoHis> WmBarcodeBatchInfoHis { get; set; }
    }
}