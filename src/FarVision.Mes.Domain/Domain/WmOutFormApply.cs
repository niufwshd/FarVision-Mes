...
{
    public partial class WmOutFormApply
 : Entity<int>    {
        public WmOutFormApply()
        {
            WmOutFormApplyItem = new HashSet<WmOutFormApplyItem>();
        }
        ...
        public DateTime? ExpectHandoverDate { get; set; }
        public string OrderNumber { get; set; }

        public virtual ICollection<WmOutFormApplyItem> WmOutFormApplyItem { get; set; }
    }
}