...
{
    public partial class SbMaintainSpec
 : Entity<int>    {
        public SbMaintainSpec()
        {
            SbMtspecInfo = new HashSet<SbMtspecInfo>();
            SbSparePart = new HashSet<SbSparePart>();
        }
        ...
        public virtual ICollection<SbMtspecInfo> SbMtspecInfo { get; set; }
        public virtual ICollection<SbSparePart> SbSparePart { get; set; }
    }
}