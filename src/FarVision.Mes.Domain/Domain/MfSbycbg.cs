...
{
    public partial class MfSbycbg
 : Entity<int>    {
        public MfSbycbg()
        {
            TfSbycbg = new HashSet<TfSbycbg>();
        }
        ...
        public string YcRem { get; set; }
        public bool? WxFlag { get; set; }
        ...
        public virtual ICollection<TfSbycbg> TfSbycbg { get; set; }
    }
}