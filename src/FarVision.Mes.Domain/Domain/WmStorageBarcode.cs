...
{
    public partial class WmStorageBarcode
 : Entity<int>    {
        public WmStorageBarcode()
        {
            WmStorageBarcodeHistory = new HashSet<WmStorageBarcodeHistory>();
        }
        ...
        public virtual ICollection<WmStorageBarcodeHistory> WmStorageBarcodeHistory { get; set; }
    }
}