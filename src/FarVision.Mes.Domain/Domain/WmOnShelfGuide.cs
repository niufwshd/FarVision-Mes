...
{
    public partial class WmOnShelfGuide
 : Entity<int>    {
        public WmOnShelfGuide()
        {
            WmOnShelfGuideItem = new HashSet<WmOnShelfGuideItem>();
        }
        ...
        public virtual ICollection<WmOnShelfGuideItem> WmOnShelfGuideItem { get; set; }
    }
}